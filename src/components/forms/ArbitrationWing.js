...
export default function ArbitrationWing() {
  ...
  return (
    <Paper elevation={5} style={{backgroundColor:'#d9d9d9',background:'transparent', width:'600px', height:'350px', marginLeft:'600px'}}>
    <ThemeProvider theme={theme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Typography component="h1" variant="h6" style={{fontWeight:'bold'}}>
            WING SERVICES:Legal /Arbitration wing
          </Typography>
      ...
      >
        ...
        <MenuItem >Payment Dispute</MenuItem>
        <MenuItem >Legal Consultation</MenuItem>
